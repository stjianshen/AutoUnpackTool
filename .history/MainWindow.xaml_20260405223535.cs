PS E:\learn\AutoUnpackTool> ^C
PS E:\learn\AutoUnpackTool> dotnet build
还原完成(0.8)
  AutoUnpackTool net10.0-windows 失败，出现 1 错误 (2.9 秒)
    E:\learn\AutoUnpackTool\MainWindow.xaml.cs(20,17): error CS0246: 未能找到类型或命名空间名“CancellationTokenSource”(是否缺少 using 指令或程序集引用?)

在 4.1 秒内生成 失败，出现 1 错误using Microsoft.Win32;
using System;
